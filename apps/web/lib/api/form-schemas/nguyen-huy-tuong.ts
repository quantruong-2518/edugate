...
/**
 * Nguyễn Huy Tưởng (THCS, lớp 6 intake). Same applicant profile as the other
 * lớp-6 forms — ID photo + student identity, primary-school results per year
 * (Thông tư 27 levels), special achievements, aspirations. The school admits by
 * catchment (huyện Đông Anh) with a placement survey, so the student code is
 * free-text and verified against the MOET registry offline during review.
 */
