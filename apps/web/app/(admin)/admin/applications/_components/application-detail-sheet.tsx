...
export function ApplicationDetailSheet({
  ...
  /** Drive the state change. Awaited so the button stays busy until the BE replies. */
  onTransition: (
        ...
        <div className="space-y-6 p-5">
          ...
          <section>
            ...
            <StateActions
              ...
              busy={busy}
              onTransition={async (transition, reason) => {
                setBusy(true);
                try {
                  await onTransition(application, transition, reason);
                } finally {
                  setBusy(false);
                }
              }}
